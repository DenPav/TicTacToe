...
public class TicTacToeModel {
    ...
    public static int PLAYER_PIC_CHOOSE;
    public static int DROID_PIC;
    ...
    public static int difficulty = HARD_DIF;
    ...
    public static void setPLAYER_PIC_CHOOSE (int i){
        if (i == 1){
            PLAYER_PIC_CHOOSE = NOUGHT;
            DROID_PIC = CROSS;
        } else {
            PLAYER_PIC_CHOOSE = CROSS;
            DROID_PIC = NOUGHT;
        }
    }
